...
import { sleep } from "jnj-lib-base-ts/basic.js";
import { mkdir, cpdir, loadJson, saveJson, saveFile } from "jnj-lib-base-ts/builtin.js";
import { Github, findGithubAccount } from "jnj-lib-base-ts/github.js";
...
const options = yargs
  ...
  .option("l", { alias: "lang", default: "node", describe: "developemnt language", type: "string" })
  ...
  .option("g", { alias: "github", default: true, describe: "Use Github Repository", type: "boolean" })
  .option("t", { alias: "template", default: "none-basic-ts", describe: "App Template", type: "string" })
  .argv;
...
const initNode = (options) => {
  ...
  // * template 폴더 복사
  const srcDir = Path.join(TEMPLATES_PATH, `node/${template}`);
